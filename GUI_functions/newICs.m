...
close all
fig = figure('Name', 'New ICs', 'Position', [100 100 400 400]);
...
annotation('textbox', [0.1 0.8 0.8 0.1], 'String', 'Enter new initial conditions', 'FontSize', 10, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'LineStyle', 'none');
...
function submitValues(src, editFields)
    ...
    % Salva i valori inseriti nel vettore ICs
    assignin('base', 'ICs', values);
    close;
    indexgui;
