...
close all
fig = figure('Name', 'Relative ICs (Deputy)', 'Position', [100 100 400 400]);
...
annotation('textbox', [0.05 0.9 0.9 0.1], 'String', 'Enter new relative initial conditions (deputy)', 'FontSize', 12, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'LineStyle', 'none');
annotation('textbox', [0.05 0.8 0.9 0.1], 'String', '(Hint: enter small relative velocities, on the order of tenths of m/s, otherwise the deputy will quickly exit the figures)', 'FontSize', 10, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle', 'LineStyle', 'none');
...
inputPositions = [100-offset 250-inputSize/2 inputSize inputSize;
                  ...
                  100-offset 130-inputSize/2 inputSize inputSize;
                  200-offset 130-inputSize/2 inputSize inputSize;
                  300-offset 130-inputSize/2 inputSize inputSize];
...
function submitValues(src, editFields)
    ...
    assignin('base', 'X0_deputy', values);
    close;
    gameimpulse;
